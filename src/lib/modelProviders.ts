...
import {
  LIN_DEFAULT_MODELS as SHARED_LIN_DEFAULT_MODELS,
  LIN_MODEL_DEFAULTS,
  isLinDefaultPlaceholder,
} from '../config/linModelDefaults';
...
export const OLLAMA_MODELS: ModelOption[] = [
  // Chatty construct models (built from /vvault/instances via scripts/build_sims.py)
  { value: 'ollama:zen', label: 'Zen (zen-001 Sim)', provider: 'ollama', category: 'general' },
  { value: 'ollama:lin', label: 'Lin (lin-001 Sim)', provider: 'ollama', category: 'general' },
  { value: 'ollama:aurora', label: 'Aurora (aurora-001 Sim)', provider: 'ollama', category: 'creative' },
  { value: 'ollama:monday', label: 'Monday (monday-001 Sim)', provider: 'ollama', category: 'general' },
  ...
  { value: 'ollama:phi4-mini:latest', label: 'Phi-4 Mini (Interaction)', provider: 'ollama', category: 'general' },
  ...
  { value: 'ollama:mistral-small3.2:24b', label: 'Mistral Small 3.2 24B (Ingenuity)', provider: 'ollama', category: 'creative' },
  ...
  { value: 'ollama:deepseek-coder:latest', label: 'DeepSeek Coder (latest)', provider: 'ollama', category: 'coding' },
  { value: 'ollama:qwen2.5-coder:latest', label: 'Qwen2.5 Coder (Intelligence)', provider: 'ollama', category: 'coding' },
  { value: 'ollama:qwen3-coder:30b', label: 'Qwen3 Coder 30B (Intelligence)', provider: 'ollama', category: 'coding' },
...
export const LIN_DEFAULT_MODELS = {
  creative: SHARED_LIN_DEFAULT_MODELS.creative,
  coding: SHARED_LIN_DEFAULT_MODELS.coding,
  smalltalk: SHARED_LIN_DEFAULT_MODELS.smalltalk,
};

export const LIN_CONVERSATION_MODEL = LIN_MODEL_DEFAULTS.conversation;
export { isLinDefaultPlaceholder };
