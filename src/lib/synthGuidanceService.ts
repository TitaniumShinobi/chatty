...
/**
 * Service for managing Synth's contextual guidance pop-ups
 * Allows Synth to guide users through workflows and explain features
 */
class SynthGuidanceService {
...
// Singleton instance
let instance: SynthGuidanceService | null = null

export function getSynthGuidanceService(): SynthGuidanceService {
  if (!instance) {
    instance = new SynthGuidanceService()
  }
  return instance
}

export default SynthGuidanceService
