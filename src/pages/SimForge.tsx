  ...
  const filteredGpts = gpts
    .filter((gpt) => {
      ...
      const matchesCategory =
        selectedCategory === "all" || gpt.category === selectedCategory;
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            >
              Discover and use community-created assistants
            </p>
          </div>
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <Star
                      size={16}
                      fill={gpt.isLiked ? "currentColor" : "none"}
                    />
                  </button>
      ...
      <GPTCreator
        ...
        onGPTCreated={(gptConfig: unknown) => {
          ...
          if (
            ...
            gptConfig &&
            typeof gptConfig === "object"
          ) {
            const config = gptConfig as {
              constructCallsign?: string;
              id?: string;
              name?: string;
            };
