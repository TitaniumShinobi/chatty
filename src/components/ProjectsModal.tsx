    ...
    >
      ...
      >
        ...
        <div className="px-6 py-5 space-y-4" style={{ color: 'var(--chatty-text)' }}>
          <div className="rounded-xl px-4 py-4" style={{ backgroundColor: 'var(--chatty-bg-sidebar)' }}>
            ...
            <div className="flex flex-wrap gap-2">
              {['Planning', 'Writing', 'Homework', 'Research', 'Personal'].map((label) => (
                <span
                  ...
                  style={{ backgroundColor: 'var(--chatty-button)', color: 'var(--chatty-text)', opacity: 0.85 }}
                >
                  {label}
                </span>
              ))}
