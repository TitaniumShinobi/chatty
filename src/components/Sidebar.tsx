    ...
    >
      ...
      <div className={cn(collapsed ? "px-3 pb-3" : "px-4 pb-4")}>
        <div className="space-y-1">
          ...
          {/* Finance (gated — hidden unless ENABLE_FINANCE=true) */}
          {typeof window !== 'undefined' && localStorage.getItem('ENABLE_FINANCE') === 'true' && (
            <button
          ...
          {/* + More - Links to Apps page (gated — hidden unless ENABLE_APPS=true) */}
          {typeof window !== 'undefined' && localStorage.getItem('ENABLE_APPS') === 'true' && (
            <button
