...
> ARCHIVE SUPERSESSION WARNING: This archived pipeline describes old file-creation behavior. It is provenance only. Current VVAULT authority is the cloud/VVAULT-owned database with write/readback proof. Do not create local transcript/archive/sync folders or treat local path materialization as VVAULT sync. See `/Users/devonwoodson/Documents/GitHub/chatty/docs/standards/vvault-authority-contract.md`.
