...
> ARCHIVE SUPERSESSION WARNING: This archived investigation describes the old file-based VVAULT model. It is provenance only. Current VVAULT authority is the cloud/VVAULT-owned database with write/readback proof. Do not use this prompt to make local VVAULT folders, read local transcript files for continuity, or treat filesystem paths as VVAULT truth. See `/Users/devonwoodson/Documents/GitHub/chatty/docs/standards/vvault-authority-contract.md`.
