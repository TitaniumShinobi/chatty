...
> ARCHIVE SUPERSESSION WARNING: This archived rubric describes the old filesystem-era VVAULT model. It is provenance only. Current VVAULT authority is the cloud/VVAULT-owned database with write/readback proof. Do not create local folders, read local transcript files for continuity, or call local file placement "VVAULT sync." See `/Users/devonwoodson/Documents/GitHub/chatty/docs/standards/vvault-authority-contract.md`.
