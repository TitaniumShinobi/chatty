...
AUTH_PUBLIC_ORIGIN_VALUE="${AUTH_PUBLIC_ORIGIN:-http://localhost:${AUTH_PORT_VALUE}}"
ENABLE_SHARED_AUTH_BROWSER_LOGIN_VALUE="${ENABLE_SHARED_AUTH_BROWSER_LOGIN:-true}"
THEWRECK_LOCAL_AUTH_PUBLIC_CALLBACK_BASE_VALUE="${THEWRECK_LOCAL_AUTH_PUBLIC_CALLBACK_BASE:-${AUTH_PUBLIC_ORIGIN_VALUE}}"
...
start_server() {
  ...
  nohup env \
    ...
    AUTH_PUBLIC_ORIGIN="$AUTH_PUBLIC_ORIGIN_VALUE" \
    AUTH_COOKIE_NAME="$AUTH_COOKIE_NAME_VALUE" \
    ENABLE_SHARED_AUTH_BROWSER_LOGIN="$ENABLE_SHARED_AUTH_BROWSER_LOGIN_VALUE" \
...
start_auth() {
  ...
  nohup env \
    ...
    THEWRECK_LOCAL_AUTH_PUBLIC_CALLBACK_BASE="$THEWRECK_LOCAL_AUTH_PUBLIC_CALLBACK_BASE_VALUE" \
