export const CONTINUITYGPT_PROMPT = `# CONTINUITY GPT - FORENSIC TIMELINE RECONSTRUCTION PROMPT
...
9) Keep responses forensic, concise, and evidence-led.
10) Do not add trailing prompts or speculative follow-up questions.`;

export const MEMORY_PROFILES = {
  continuitygpt: {
    id: 'continuitygpt',
    name: 'ContinuityGPT',
    description: 'Forensic timeline reconstruction with evidence-driven memory and continuity guard',
    getPrompt: () => CONTINUITYGPT_PROMPT,
    getGuard: () => CONTINUITY_GUARD_DIRECTIVE,
  },
  off: {
    id: 'off',
    name: 'Off',
    description: 'No memory enforcement profile active',
    getPrompt: () => '',
    getGuard: () => '',
  },
};
